    ...
    return (
      <TouchableOpacity>
        <View style={tw`bg-white p-2 m-1 rounded-lg`}>
          ...
          />
          <View style={tw`absolute bottom-24 right-11 bg-orange-600 p-3 rounded-full border-2 border-white `}>
            <Feather name="bookmark" size={24} color="white" />
          </View>
          <Text style={tw`text-lg font-bold p-3 `}>{item.name}</Text>
          <View style={tw`flex-row justify-between p-2 `}>
            <View style={tw`flex-row gap-2 items-center`}>
                <FontAwesome name="map-marker" size={26}  style={tw`text-orange-600`} />
